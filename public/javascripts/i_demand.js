...
xhttp.open("GET", `http://localhost:3000/i_tables`, false);
xhttp.send();
...
for(i=0;i<jsonTable.length;i++){
	...
	cell6.innerHTML = "<a href='/i_approve?id="+obj+"&category="+category+"&qty="+qty+"'>Approve</a>";
